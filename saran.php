        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4 text-center">Pesan Pengguna</h1>
                        ...
                        <div class="card-body">
                            <table class="table table-bordered" id="datatablesSimple" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    $ambilsemuadata = mysqli_query($conn, "SELECT*FROM pesan");
                                    $i = 1;
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button name="hapuspesan" type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete<?= $id_pesan; ?>">
                                                    Hapus
                                                </button>
                                            </td>

                                            <!-- MODAL Hapus -->
                                            <div class="modal fade" id="delete<?= $id_pesan; ?>">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <!-- Modal body -->
                                                        <form method="post" name="hapuspesan" action="prosesHapus.php">
                                                            <div class="modal-body">
                                                                Apakah anda yakin ingin menghapus pesan ini?
                                                                <input type="hidden" id="id_pesan" name="id_pesan" value="<?= $id_pesan; ?>">
                                                                <br><br>
                                                                <button type="submit" id="hapuspesan" name="hapuspesan" class="btn btn-danger">Hapus</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
