                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete<?= $id_user; ?>">
                                                    Hapus
                                                </button>
                                            </td>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post" action="prosesHapus.php">
                                                            <div class="modal-body">
                                                                Apakah anda yakin ingin menghapus seluruh data <?= $nama_lengkap; ?> dengan username <?= $username; ?> ?
                                                                <input type="hidden" name="id_user" value="<?= $id_user; ?>">
                                                                <br><br>
